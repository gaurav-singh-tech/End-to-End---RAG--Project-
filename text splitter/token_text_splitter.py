...
splitter = TokenTextSplitter(chunk_size=1000,#The chunk_size parameter specifies the maximum number of characters that each chunk should contain. In this case, we have set it to 10, which means that each chunk will contain at most 10 characters from the original document.
